...
namespace QuantumSuperposition.Operators
{
    ...
    public class ULongOperators : IQuantumOperators<ulong>
    {
        ...
        public bool GreaterThan(ulong a, ulong b)
        {
            return a > b;
        }

        public bool GreaterThanOrEqual(ulong a, ulong b)
        {
            return a >= b;
        }
        ...
        public bool LessThanOrEqual(ulong a, ulong b)
        {
            return a <= b;
        }
        ...
        public bool NotEqual(ulong a, ulong b)
        {
            return a != b;
        }
