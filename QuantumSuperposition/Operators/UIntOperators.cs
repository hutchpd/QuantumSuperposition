...
namespace QuantumSuperposition.Operators
{
    ...
    public class UIntOperators : IQuantumOperators<uint>
    {
        ...
        public bool GreaterThan(uint a, uint b)
        {
            return a > b;
        }

        public bool GreaterThanOrEqual(uint a, uint b)
        {
            return a >= b;
        }
        ...
        public bool LessThanOrEqual(uint a, uint b)
        {
            return a <= b;
        }
        ...
        public bool NotEqual(uint a, uint b)
        {
            return a != b;
        }
