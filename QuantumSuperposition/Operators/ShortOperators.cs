...
namespace QuantumSuperposition.Operators
{
    ...
    public class ShortOperators : IQuantumOperators<short>
    {
        ...
        public short Mod(short a, short b) => (short)(a % b);

        public bool GreaterThan(short a, short b) => a > b;
        public bool GreaterThanOrEqual(short a, short b) => a >= b;
        public bool LessThan(short a, short b) => a < b;
        public bool LessThanOrEqual(short a, short b) => a <= b;
        public bool Equal(short a, short b) => a == b;
        public bool NotEqual(short a, short b) => a != b;
