...
namespace QuantumSuperposition.Operators
{
    ...
    public class UShortOperators : IQuantumOperators<ushort>
    {
        ...
        public ushort Mod(ushort a, ushort b) => (ushort)(a % b);

        public bool GreaterThan(ushort a, ushort b) => a > b;
        public bool GreaterThanOrEqual(ushort a, ushort b) => a >= b;
        public bool LessThan(ushort a, ushort b) => a < b;
        public bool LessThanOrEqual(ushort a, ushort b) => a <= b;
        public bool Equal(ushort a, ushort b) => a == b;
        public bool NotEqual(ushort a, ushort b) => a != b;
