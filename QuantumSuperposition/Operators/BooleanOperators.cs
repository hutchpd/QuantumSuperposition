...
namespace QuantumSuperposition.Operators
{
    ...
    public class BooleanOperators : IQuantumOperators<bool>
    {
        ...
        {
            return a && !b; // arbitrary definition
        }
        ...
        {
            throw new NotSupportedException("Division not supported for booleans, why are you trying to divide truth?.");
        }

        public bool Mod(bool a, bool b)
        {
            throw new NotSupportedException("I don't even know what that could possibly mean.");
        }
        ...
        public bool GreaterThanOrEqual(bool a, bool b)
        {
            return a == b; // or false
        }

        public bool LessThan(bool a, bool b)
        {
            return false;
        }

        public bool LessThanOrEqual(bool a, bool b)
        {
            return a == b;
        }
        ...
        public bool NotEqual(bool a, bool b)
        {
            return a != b;
        }
