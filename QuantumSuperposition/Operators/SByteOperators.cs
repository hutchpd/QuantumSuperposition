...
namespace QuantumSuperposition.Operators
{
    ...
    public class SByteOperators : IQuantumOperators<sbyte>
    {
        ...
        public sbyte Mod(sbyte a, sbyte b) => (sbyte)(a % b);

        public bool GreaterThan(sbyte a, sbyte b) => a > b;
        public bool GreaterThanOrEqual(sbyte a, sbyte b) => a >= b;
        public bool LessThan(sbyte a, sbyte b) => a < b;
        public bool LessThanOrEqual(sbyte a, sbyte b) => a <= b;
        public bool Equal(sbyte a, sbyte b) => a == b;
        public bool NotEqual(sbyte a, sbyte b) => a != b;
