...
{
    public sealed class BitwiseAndOperation<T> : IReversibleSnapshotOperation<T>
        where T : IComparable<T>
    {
        ...
        public string OperationName => $"Bitwise AND with {Operand}";

        public BitwiseAndOperation(PositronicVariable<T> variable, T operand, IPositronicRuntime _)
        {
            Variable = variable;
            Operand = operand;
        ...
        public T ApplyForward(T value) => Bitwise.And(value, Operand);
    }
}